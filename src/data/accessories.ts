...
export const ACCESSORIES: Record<string, AccessoryConfig> = {
  ...
  "en-m300": {
    ...
    accessories: [
      { id: "wire-cutting-edm-dk7735", name: "Wire-cutting machine (EDM DK7735)", priceCents: 1_800_000 },
      { id: "grinding-my3060", name: "Grinding machine MY3060", priceCents: 1_600_000 },
      { id: "sieving-ffm-400-1s", name: "Sieving machine FFM-400-1S", priceCents: 1_100_000 },
      { id: "vacuum-explosion-proof", name: "Vacuum cleaner (explosion-proof)", priceCents: 900_000 },
      { id: "nitrogen-generator-a3", name: "Nitrogen generator A3", priceCents: 600_000 },
      { id: "muffle-furnace", name: "Muffle heat-treatment furnace", priceCents: 400_000 },
      { id: "screw-air-compressor-bk75", name: "Screw air compressor BK-7.5", priceCents: 300_000 },
      { id: "voltage-stabilizer-30kw", name: "Voltage stabilizer 30KW", priceCents: 240_000 },
      { id: "sandblasting-9060", name: "Sandblasting machine 9060", priceCents: 200_000 },
      { id: "drying-oven-101-1ab", name: "Drying oven 101-1AB", priceCents: 120_000 },
    ],
  },
  "en-m420": {
    mode: "a_la_carte",
    ...
    accessories: [
      { id: "wire-cutting-dk7745", name: "Wire-cutting machine DK7745", priceCents: 2_000_000 },
      { id: "sieving-inert-gas", name: "Auto-feeding sieving machine (inert gas)", priceCents: 1_100_000 },
      { id: "vacuum-explosion-proof", name: "Vacuum cleaner (explosion-proof)", priceCents: 900_000 },
      { id: "n2-generator", name: "N2 generator", priceCents: 600_000 },
      { id: "muffle-furnace", name: "Muffle heat-treatment furnace", priceCents: 400_000 },
      { id: "voltage-stabilizer-40kw", name: "Voltage stabilizer 40KW", priceCents: 300_000 },
      { id: "powder-drying-oven", name: "Powder drying oven", priceCents: 160_000 },
    ],
  },
  "en-m800": {
